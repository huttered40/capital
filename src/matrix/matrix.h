...
public:
  ...
  inline DimensionType offset_local(DimensionType coordX, DimensionType coordY, size_t buffer) const { return buffer != 2 ? _offset(coordX,coordY,this->_dimensionX,this->_dimensionY) : rect::_offset(coordX,coordY,this->_dimensionX,this->_dimensionY);}
