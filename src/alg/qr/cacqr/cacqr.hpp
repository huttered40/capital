...
void cacqr::invoke_1d(MatrixAType& A, MatrixRType& R, typename MatrixRType::ScalarType* RI, ArgType&& args, CommType&& CommInfo){
  ...
  MPI_Allreduce(MPI_IN_PLACE, R.data(), localDimensionN*localDimensionN, mpi_type<T>::type, MPI_SUM, CommInfo.world);
...
template<typename MatrixAType, typename MatrixRType, typename ArgType, typename CommType>
void cacqr::invoke_3d(MatrixAType& A, MatrixRType& R, MatrixRType& RI, ArgType&& args, CommType&& CommInfo){
...
void cacqr::invoke(MatrixAType& A, MatrixRType& R, MatrixRType& RI, ArgType&& args, RectCommType&& RectCommInfo, SquareCommType&& SquareCommInfo){
...
template<typename MatrixAType, typename MatrixRType, typename ArgType, typename CommType>
void cacqr::invoke(MatrixAType& A, MatrixRType& R, ArgType&& args, CommType&& CommInfo){
  using T = typename MatrixAType::ScalarType;
  using U = typename MatrixAType::DimensionType;
...
template<typename MatrixAType, typename MatrixRType, typename ArgType, typename CommType>
void cacqr2::invoke_1d(MatrixAType& A, MatrixRType& R, ArgType&& args, CommType&& CommInfo){
  ...
  std::vector<T> RI(localDimensionN*localDimensionN);
  cacqr::invoke_1d(A, R, &RI[0], std::forward<ArgType>(args), std::forward<CommType>(CommInfo));
  R.swap();
  cacqr::invoke_1d(A, R, &RI[0], std::forward<ArgType>(args), std::forward<CommType>(CommInfo));
  R.swap();
...
template<typename MatrixAType, typename MatrixRType, typename ArgType, typename CommType>
void cacqr2::invoke_3d(MatrixAType& A, MatrixRType& R, ArgType&& args, CommType&& CommInfo){
  ...
  cacqr::invoke_3d(A, R, RI, std::forward<ArgType>(args), std::forward<CommType>(CommInfo));
  cacqr::invoke_3d(A, R2, RI, std::forward<ArgType>(args), std::forward<CommType>(CommInfo));
...
template<typename MatrixAType, typename MatrixRType, typename ArgType, typename CommType>
void cacqr2::invoke(MatrixAType& A, MatrixRType& R, ArgType&& args, CommType&& CommInfo){
  if (CommInfo.c == 1){
  ...
  cacqr::invoke(A, R, RI, std::forward<ArgType>(args), std::forward<CommType>(CommInfo), SquareTopo);
  cacqr::invoke(A, R2, RI, std::forward<ArgType>(args), std::forward<CommType>(CommInfo), SquareTopo);
...
void cacqr::solve_upper_left(MatrixAType& matrixA, MatrixUType& matrixU, MatrixUIType& matrixUI, CommType&& CommInfo,
