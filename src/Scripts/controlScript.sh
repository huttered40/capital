...
launch$tag3 () {
  ...
  then
	...
	echo "echo \"\${8}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
	echo "echo \"\${9}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
	echo "echo \"\${startPdimD}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
  ...
  then
    ...
    do
        # Write to plotInstructions file
	echo "echo \"\${startMatrixDimM}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
	echo "echo \"\${11}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
	echo "echo \"\${startPdimD}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
	echo "echo \"\${pDimC}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
	echo "echo \"\${14}\"" >> $SCRATCH/${fileName}/plotInstructions.sh
