...
public:
  ...
  void choleskyLAPack
  (
	std::vector<T> &data, std::vector<T> &dataL,
	std::vector<T> &dataLInverse,
	uint32_t n,
	bool needData
  );
  
  void getResidualLayer
  (
	std::vector<T> &matA,
	std::vector<T> &matL,
	std::vector<T> &matLI
