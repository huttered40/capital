...
int main(int argc, char** argv){
  ...
  { 
    ...
    size_t space_dim = 15;
    vector<double> save_data(num_iter*space_dim*(1+30));
...
#ifdef CRITTER
          critter::stop();
          if (i<(num_iter-1)) critter::record(&save_data[1*num_iter*space_dim+30*(k*num_iter+i)],false,true);
          else                critter::record(&save_data[1*num_iter*space_dim+30*(k*num_iter+i)],true,true);
#endif
    ...
    if (rank==0){
      ...
      for (size_t k=0; k<space_dim; k++){
        for (size_t i=0; i<num_iter; i++){
          ...
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+0];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+1];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+2];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+3];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+4];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+5];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+6];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+7];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+8];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+9];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+10];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+11];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+12];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+25];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+26];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+27];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+28];
          stream_max << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+29];
          stream_max << std::endl;

          stream_vol << std::left << std::setw(width) << k;
          stream_vol << std::left << std::setw(width) << save_data[0*space_dim*num_iter+k*num_iter+i];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+0];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+13];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+14];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+15];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+16];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+17];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+18];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+19];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+20];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+21];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+22];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+23];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+24];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+25];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+26];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+27];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+28];
          stream_vol << std::left << std::setw(width) << save_data[1*space_dim*num_iter+30*(k*num_iter+i)+29];
          stream_vol << std::endl;
        }
      }
    }
