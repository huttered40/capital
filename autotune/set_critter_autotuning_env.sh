...
export CRITTER_AUTOTUNING_TEST=0
...
export CRITTER_VIZ_FILE=Test-${CRITTER_AUTOTUNING_TEST}__mechanism-${CRITTER_MECHANISM}_mode-${CRITTER_AUTOTUNING_AGGREGATION_MODE}_opt-${CRITTER_AUTOTUNING_OPTIMIZE}_comm-envelope-${CRITTER_COMM_ENVELOPE_PARAM}_comm-unit-${CRITTER_COMM_UNIT_PARAM}_comm-analysis-${CRITTER_COMM_ANALYSIS_PARAM}_comp-envelope-${CRITTER_COMP_ENVELOPE_PARAM}_comp-unit-${CRITTER_COMP_UNIT_PARAM}_comp-analysis-${CRITTER_COMP_ANALYSIS_PARAM}_error-limit-${CRITTER_PATTERN_ERROR_LIMIT}_time-limit-${CRITTER_PATTERN_TIME_LIMIT}_count-limit-${CRITTER_PATTERN_COUNT_LIMIT}
